...
def discover_partition_workload(logger: logging.Logger) -> List[str]:
    ...
    try:
        ...
        # TICKET-143: Hardcode single 775G partition for focused debugging
        partitions = ["lake-775g-2-2262_2025-07-30"]
...
def process_single_partition(device_date: str, log_file: Path) -> Tuple[str, float, Dict[str, Any]]:
    ...
    try:
        ...
        has_reliable_payload = df['has_reliable_payload'][0] if len(df) > 0 else False
