-- Fixed atomic table swap script
-- This version handles index naming conflicts properly
...
-- Step 2: Drop existing indexes on old table to avoid naming conflicts
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_timestamp;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_device_id;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_device_timestamp;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_ingested_at;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_state;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_software_state;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_position_gist;
DROP INDEX IF EXISTS idx_02_raw_telemetry_transformed_extras_gin;
...
-- Step 4: Rename new table's indexes to standard names
...
-- Step 6: Add column comment and update statistics
...
-- Step 7: Display final migration summary
SELECT 
